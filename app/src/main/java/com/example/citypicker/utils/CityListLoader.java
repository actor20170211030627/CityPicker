...
import com.example.citypicker.bean.CityInfoBean;
...
public class CityListLoader {
    ...
    private List<CityInfo> citys;//所有城市

    private CityListLoader() {
        throw new RuntimeException("can't new");
    }
    ...
    public void init(final Context context) {
        new Thread(new Runnable() {
            ...
            public void run() {
                ...
                citys = new Gson().fromJson(cityJson, type);
            }
        }).start();
    }
