...
/**
 * Description: 省的Adapter
 * Copyright  : Copyright (c) 2019
 * Company    : 重庆市了赢科技有限公司 http://www.liaoin.com/
 * Author     : 李大发
 * Date       : 2019/8/10 on 21:03
 */
public class ProvinceAdapter extends RecyclerView.Adapter<ProvinceAdapter.MyViewHolder> {
    ...
    public ProvinceAdapter(List<CityInfo> provinces, int selectedPosition) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder myViewHolder, int position) {
        ...
        myViewHolder.tvAddress.setText(provinces.get(position).name);
